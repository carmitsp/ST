...
if len(sys.argv) < 2:
    print('Usage: python3 layout_repair_keep_footnotes.py "file.docx"')
    sys.exit(1)

infile = Path(sys.argv[1])
outfile = infile.with_name(infile.stem + "_LAYOUT_REPAIR_KEEP_FOOTNOTES.docx")

NS_W = "http://schemas.openxmlformats.org/wordprocessingml/2006/main"
ET.register_namespace("w", NS_W)

# Keep footnoteReference and endnoteReference.
# Remove only layout/cache/break structures.
REMOVE = {
    "br",
    "sectPr",
